...
REPORT_CONCURRENCY_COOLDOWN_SECONDS = max(_int_env("REPORT_CONCURRENCY_COOLDOWN_SECONDS", 120), 0)
...
INTERNAL_API_METHOD = os.getenv("INTERNAL_API_METHOD", "GET").strip().upper()
...
INTERNAL_API_BASIC_USERNAME = os.getenv("INTERNAL_API_BASIC_USERNAME", "").strip()
INTERNAL_API_BASIC_PASSWORD = os.getenv("INTERNAL_API_BASIC_PASSWORD", "").strip()
